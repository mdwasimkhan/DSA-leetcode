 ...
 */
class E_724_Find_Pivot_Index {
		// First attempt
		// public int pivotIndex(int[] nums) {
		//     Solution solution = new Solution();
		//     int size = nums.length;
		//     for(int i=0;i<size;i++){
		//         if(i==0 && solution.getSum(1, size, nums)==0){
		//             return 0;
		//         }else if(solution.getSum(0, i, nums) == solution.getSum(i+1, size, nums)){
		//             return i;
		//         }
		//     }
		//     return -1;
		...
		public static void main(String[] args) {
			...
			E_724_Find_Pivot_Index object = new E_724_Find_Pivot_Index();
